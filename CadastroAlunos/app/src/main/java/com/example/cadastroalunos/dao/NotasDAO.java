...
public class NotasDAO {
    ...
    public static Notas getNotas(int id){
        try{
            ...
            Log.e("Erro", "Erro ao retornar a Notas: "+ex.getMessage());
            return null;
        }
    }

    public static List<Notas> retornaNotas(String where, String[]whereArgs, String orderBy){
        List<Notas> list = new ArrayList<>();
        try{
            list = Notas.find(Notas.class, where, whereArgs, "", orderBy, "");
        }catch (Exception ex){
            Log.e("Erro", "Erro ao retornar lista de Notass: "+ex.getMessage());
        }
        return list;
    }
    ...
    public static boolean delete(Notas notas){
        try{
            ...
            Log.e("Erro", "Erro ao apagar a Notas: "+ex.getMessage());
            return false;
        }
    }
}
